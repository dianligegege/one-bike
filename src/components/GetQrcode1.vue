<template>
  <div>
    ...
    <a-button style="position: fixed; bottom: 180px; z-index: 1000" @click="closeScan">关闭扫码</a-button>
  </div>
</template>
...
export default {
  ...
  mounted () {
    if (origin.indexOf("https") === -1) {
      console.warning("请在 https 环境中使用本插件。");
    }
  ...
  methods: {
    ...
    openScan () {
      ...
      navigator.mediaDevices
        ...
        .catch((err) => {
          console.warning("设备不支持,请检查是否允许摄像头权限");
